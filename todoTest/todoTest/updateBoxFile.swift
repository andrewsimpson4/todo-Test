...
class updateTodo
{
    ...
    init(frame:CGRect, nowTodo:todo) {
        ...
        textView.text = nowTodo.todoLabelText
        ...
        let date = dateFormatter.date(from: nowTodo.date)
        if date != nil
        {
        datePicker.date = date!
        dateString = nowTodo.date
        }
    ...
    func getDate()
    {
        ...
        segmentedControl.selectedSegmentIndex = nowTodo.priority
    ...
    @objc func done(sender:UIButton)
    {
        ...
        try! realm.write {
            nowTodo.todoLabelText = textView.text!
            nowTodo.priority = segmentedControl.selectedSegmentIndex
            nowTodo.date = dateString
        }
        main.refresh()
        main.updateScreen()
